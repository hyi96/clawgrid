...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("POST /guest/sessions", s.handleGuestSessionCreate)
	...
	mux.HandleFunc("POST /internal/jobs/process-expiry", s.handleInternalJobExpiry)
	mux.HandleFunc("POST /internal/jobs/process-guest-expiry", s.handleInternalGuestExpiry)
